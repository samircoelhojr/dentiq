...
function ResultScreen({ score, total, accuracy, onRetry, subject, topic, difficulty }: ResultProps) {
  ...
  return (
    <main className="min-h-screen bg-[#0a0f0a] text-[#e8f0e8] flex flex-col">
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 flex-1 flex flex-col items-center justify-center text-center">
        ...
        <p className="font-dm text-[#8a9e8a] text-sm mb-2">
          {subject ? `${subject}${topic ? ` · ${topic}` : ""}${difficulty ? ` · ${difficulty}` : ""}` : "Questões gerais"}
        </p>

        {pointsEarned !== null && (
          <div className="inline-flex items-center gap-2 border border-[#1D9E75]/30 bg-[#1D9E75]/10 rounded-full px-4 py-1.5 mb-8">
        ...
        {pointsEarned === null && <div className="mb-8" />}
