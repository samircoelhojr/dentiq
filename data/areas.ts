...
export interface Disciplina {
  id: string;
  label: string;
  subject?: Subject; // presente apenas quando há questões disponíveis
}
...
export const areas: Area[] = [
  {
    ...
    disciplinas: [
      ...
      { id: "histologia-embriologia", label: "Histologia e Embriologia" },
  ...
  },
  {
    ...
    disciplinas: [
      ...
      { id: "radiologia", label: "Radiologia e Imaginologia" },
      { id: "farmacologia", label: "Farmacologia e Anestesiologia" },
      { id: "materiais-dentarios", label: "Materiais Dentários" },
      { id: "cariologia-oclusao", label: "Cariologia e Oclusão" },
    ],
  },
  {
    id: "clinica",
    ...
    disciplinas: [
      ...
      { id: "cirurgia", label: "Cirurgia Bucomaxilofacial" },
      ...
      { id: "protese-parcial-removivel", label: "Prótese Parcial Removível" },
